...
import { SearchScreen } from '../components/searchServices/SearchScreen'
export const DashBoardRouter = () => {
    ...
    useEffect(() => {
        if (!state.checking && !services.loaded) dispatch(getServicesUser())
    }, [state.checking, services.loaded, dispatch])

    if (state.checking) return <div className="preloader"></div>
    return (
        <>
            <div style={{ minHeight: '100vh' }}>
                ...
                <Routes>
                    ...
                    />
                    <Route
                        path="service/gallery/:idService"
