			...
			<div className="modal-dialog modal-dialog-centered">
				<div className="modal-content">
					<div className="modal-header">
						<h5 className="modal-title" id="modalEdit">Modificación de comentario.</h5>
					...
					<div className='modal-footer'>
						...
						<button type='submit' className='btn btn-primary' onClick={handleEditComment} data-bs-dismiss='modal'>Enviar</button>
					</div>
