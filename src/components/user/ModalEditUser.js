...
export const ModalEditUser = ({ idModal }) => {
  ...
  const isFormValid = () => {
    if (userName.trim().length === 0) {
      ...
      Swal.fire("Error", "Las contraseñas introducidas no coinciden", "error");
      return false;
    }
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (isFormValid()) {
      if (user.userName === userName) dispatch(putUser(email, password, type));
            ...
            <div className="modal-body">
              <form className="form-group" onSubmit={handleSubmit}>
                ...
                <div className="alert alert-info mt-3">
                  <p>Si no estableces el email, no se te moficará el email.</p>
                </div>
                ...
                <div className="alert alert-info mt-3">
                  <p>
                    Si no estableces contraseña, no se te moficará la
                    contraseña.
                  </p>
                </div>
                <label
