...
export const ActionsService = ({idUserService, uidService}) => {
    ...
    return (
        <>
        {
            ...
            (
                <>
                    ...
                    >Añadir Post</button>
                    <ModalNewPost idModal={'NewPost'+ uidService} idService={uidService}/>
                    ...
                    <ModalNewWork idService={uidService} idModal={'NewWork'+uidService}/>
                    ...
                    <ModalGestionDatos idService={uidService} idModal={'EditService'+uidService}/>
                </>
        ...
        <button className='btn btn-secondary mt-1'><Link className='link-light' style={{textDecoration:'none'}}to={'/service/gallery/'+uidService}>Galería</Link></button>
        </>
    )
}
