    ...
    return (
        <>
            <div className="container-front-image" >
                <img  src="https://res.cloudinary.com/tfgbartozambrana/image/upload/v1652269852/Galeria-Trabajos_v24mk8.jpg" alt="Galería" />
            </div>
                        ...
                        (works.uidWorkService === idService) &&
                            (
                                works.worksLastService.map((work)=>{
                                    return (<GalleryItem key={work.uid} description={work.description} images={work.photos} uid={work.uid} />)
                                })
                            )
